//Следующий код является нагромаждением инструкций и костылей. Программа была написана к горячем порядке, поэтому структурированию и функциональности время не уделялось.
